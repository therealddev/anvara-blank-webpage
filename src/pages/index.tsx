...
const ContestPage = () => {
  return (
    <div className="min-h-screen bg-white p-8 max-w-4xl mx-auto">
      ...
      <h2 className="text-xl font-bold mb-4">Save the Date</h2>
      <p className="mb-8">
        Join us for our live LinkedIn winner announcement on 12/10/2024.
        We'll be revealing the lucky winner at 11:11AM ET.
      </p>

      <p className="mb-8">Choose your Rolex, Birkin, or first-class vacation.</p>

      <h2 className="text-xl font-bold mb-4">Anvara Contest Official Rules</h2>
      <div className="space-y-4">
        <p className="font-bold">NO PURCHASE NECESSARY TO ENTER OR WIN. A PURCHASE DOES NOT INCREASE THE CHANCES OF WINNING.</p>
        
        <section className="space-y-4">
          <div>
            <h3 className="font-bold">1. Sponsor</h3>
          ...
          <div>
            <h3 className="font-bold">3. Contest Period</h3>
          ...
          <div>
            <h3 className="font-bold">4. How to Enter</h3>
            ...
            <p>Limit: One (1) entry per person. Any attempt to submit additional entries by using multiple identities or other means may result in disqualification.</p>
          </div>

          <div>
            <h3 className="font-bold">5. Prize</h3>
            ...
            <p>The Approximate Retail Value ("ARV") of the prize is up to $12,369. Prize is non-transferable, non-exchangeable, and cannot be redeemed for cash. Sponsor reserves the right to substitute a prize of equal or greater value in its sole discretion.</p>
          </div>

          <div>
            <h3 className="font-bold">6. Winner Selection</h3>
          ...
          <div>
            <h3 className="font-bold">8. Publicity Release</h3>
          ...
          <div>
            <h3 className="font-bold">9. General Conditions</h3>
          ...
          <div>
            <h3 className="font-bold">11. Disputes</h3>
          ...
          <div>
            <h3 className="font-bold">13. Sponsor</h3>
            <p>
              Anvara, Inc.<br />
              101 MacDougal St<br />
              New York, NY 10012
